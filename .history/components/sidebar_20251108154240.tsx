...
import { LogOut, LayoutDashboard, Users, PhoneCall, Settings, BarChart3 , Upload} from "lucide-react"
...
const dashboards = {
  admin: [
    ...
    { icon: Upload, label: "Upload Contacts", href: "/dashboard/admin/upload" },
  ...
  manager: [
    ...
    { icon: PhoneCal, label: "View Contacts", href: "/dashboard/admin/contacts" },
    { icon: PhoneCall, label: "Upload Contacts", href: "/dashboard/admin/upload" },
